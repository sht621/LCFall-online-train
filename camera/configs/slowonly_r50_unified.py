...
#
# Single camera training route for online retraining
# =============================================================================

_base_ = '/LCFall/external_libs/mmaction2/configs/_base_/default_runtime.py'

_camera_class_weight = [1.0, 1.2679]

# カスタムモジュールのインポート
custom_imports = dict(
    imports=[
        'src.online_train.camera.support.lowlight_dataset',
        'src.online_train.camera.support.f1_evaluator',
    ],
...
model = dict(
    ...
    cls_head=dict(
        ...
        loss_cls=dict(
            ...
            class_weight=_camera_class_weight
        )))
...
# 既存のアノテーションファイルを使用
ann_file_train = '/LCFall/src/online_train/annotations/lcfall_online_retrain_train.pkl'
ann_file_val = '/LCFall/src/online_train/annotations/lcfall_online_retrain_val.pkl'
ann_file_test = '/LCFall/src/online_train/annotations/lcfall_online_retrain_test.pkl'
...
test_evaluator = dict(
    ...
    pos_label=1,
    out_file_path='/LCFall/src/online_train/generated/samples/preds_camera.json',
...
work_dir = '/LCFall/src/online_train/camera/checkpoints/train_subject_split'
